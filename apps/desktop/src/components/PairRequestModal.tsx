// Pairing request dialog: the decision is forced — no onClose is passed, so
// clicking the scrim cannot dismiss it

import { useI18n } from "../i18n";
import type { PeerDto } from "../types";
import { Button, ModalShell } from "./ModalShell";

/** Confirmation dialog for an inbound pairing request */
